...
//         var API_URL = ('https:' == location.protocol ? 'https:' : 'http:') + '//formoid.net/api/push';
        var API_URL = 'https://docs.google.com/forms/d/e/1FAIpQLSf8H4rHZ-dHpUIA8oVWSSlmvn3zsjx_1s6sQWO1R_pE5vuWMQ/formResponse'
...
//                 defer.reject(error);
    ...
    $('[data-form-type="TFD-contact-form"]').each(function () {
        var form,
            $this = $(this),
