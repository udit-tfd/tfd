...
//         var API_URL = ('https:' == location.protocol ? 'https:' : 'http:') + '//formoid.net/api/push';
        var API_URL = 'https://docs.google.com/forms/d/e/1FAIpQLSczabW6FgLbRwy8geI5cwizXwCPBP-DK2nJRC0SYq7aEsLHPA/formResponse';
...
//                 defer.reject(error);
            ...
            $('[data-form-type="TFD-form"]').hide(400);
            
            setTimeout(function () {
                $('[data-form-type="TFD-form"]').html('<p id="messsage" class="mbr-title pt-2 mbr-fonts-style display-5" style="color:#ffffff;text-align: left;">Thank you. We will contact you soon.</p>');
            }, 400);
            $('[data-form-type="TFD-form"]').show(400);
    ...
    $('[data-form-type="TFD-form"]').each(function () {
        var form,
            $this = $(this),
...
// Change the form data into compatible Google-form data 
function changeToQueryString(object)
{
    var parameters = [];
    object.forEach(item => parameters.push(encodeURI(item[0] + '=' + item[1])));
